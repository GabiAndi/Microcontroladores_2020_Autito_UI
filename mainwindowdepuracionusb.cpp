...
#include "ui_mainwindowdepuracionusb.h"

MainWindowDepuracionUSB::MainWindowDepuracionUSB(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindowDepuracionUSB)
{
    ui->setupUi(this);
...
MainWindowDepuracionUSB::~MainWindowDepuracionUSB()
{
    delete ui;
}
...
void MainWindowDepuracionUSB::on_pushButtonLimpiar_clicked()
{
...
void MainWindowDepuracionUSB::on_pushButtonCapturaDeDatos_clicked()
{
